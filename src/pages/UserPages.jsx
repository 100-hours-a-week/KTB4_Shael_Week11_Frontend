...
export function ProfileEditPage() {
  ...
  return <><Header backTo="/posts/posts.html" /><main className="profile-edit-page"><section className="profile-edit-container"><h2 className="profile-edit-title">회원정보 수정</h2><form className="profile-edit-form" onSubmit={submit}>
...
export function PasswordEditPage() {
  ...
  return <><Header backTo="/posts/posts.html" /><main className="password-edit-page"><section className="password-edit-container"><h2 className="password-edit-title">비밀번호 수정</h2><p className="password-edit-subtitle">안전한 비밀번호로 수정해주세요.</p><form className="password-edit-form" onSubmit={submit}>
